...
return [
    ...
    | versions telles que les règles de taille. N'hésitez pas à modifier chaque
    | message ici.
    |
    */
    ...
    */
    ...
    | placeholder d'attribut par quelque chose de plus convivial pour le
