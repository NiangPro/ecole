    ...
    <style>
        ...
        * {
        ...
        .error-code {
            ...
            font-size: 12rem;
            font-weight: 900;
            background: linear-gradient(135deg, #8b5cf6 0%, #06b6d4 50%, #14b8a6 100%);
...
<body>
    <div class="error-container">
        ...
        <h1 class="error-title">Service Indisponible</h1>
        <p class="error-message">
            Le service est temporairement indisponible pour maintenance.<br>
