...
@section('content')
<!-- Hero Section -->
<section class="bourses-hero">
    <div class="container mx-auto">
        <h1>🎓 Bourses d'Études</h1>
        <p>Découvrez les meilleures opportunités de bourses d'études disponibles au Sénégal et à l'étranger pour financer votre formation.</p>
    </div>
</section>
...
<div class="bourses-container">
    ...
    <div class="no-articles">
        ...
        <h3>Aucune bourse disponible</h3>
