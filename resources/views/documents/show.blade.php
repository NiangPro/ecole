    ...
    <div class="document-detail-container">
        ...
        <aside class="document-sidebar">
            <div class="purchase-card">
                ...
                @else
                    <button type="button" class="checkout-btn-doc" onclick="openWaveDirectModal()">
...
@if(!$document->isFree() && !$userHasPurchased)
...
<div id="wave-direct-modal" class="wd-overlay" style="display:none;">
    <div class="wd-modal">
        ...
        <div class="wd-body">
            {{-- ÉTAPE 1 : Formulaire --}}
            <div id="wd-step-form">
                <p class="wd-desc">Renseignez vos informations pour recevoir votre document.</p>
                <div class="wd-amount">
                    <span>Montant à payer</span>
                    <strong>{{ number_format($document->current_price, 0, ',', ' ') }} FCFA</strong>
                </div>
                ...
                <form id="wd-form" onsubmit="return false;">
                    ...
                    <button type="button" class="wd-confirm-btn" id="wd-confirm-btn" onclick="confirmWaveDirect({{ $document->id }})">
                        <i class="fas fa-check-circle"></i>
            ...
            <div id="wd-step-success" style="display:none;">
                ...
                <p class="wd-success-text">
                    ...
                    Une fois le paiement effectué, votre document vous sera envoyé par email.
                </p>
...
<script>
    ...
    function openWaveDirectModal() {
        ...
        if (!modal) return;
        // Toujours réinitialiser sur l'étape formulaire
    ...
    function confirmWaveDirect(documentId) {
        ...
        fetch('{{ url('/documents') }}/' + documentId + '/wave-direct', {
            method: 'POST',
            body: fd,
        ...
        .then(({ ok, data }) => {
            if (ok && data.success && data.wave_link) {
                // Ouvrir le QR code Wave dans le nouvel onglet
                if (waveTab) {
                    waveTab.location.href = data.wave_link;
                } else {
                    window.open(data.wave_link, '_blank');
                }
                // Préparer le bouton de réouverture
