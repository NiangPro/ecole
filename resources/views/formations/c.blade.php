...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.c.title'), 'url' => url()->current()],
    ];
@endphp
...
<style>
    * {
    ...
    .tutorial-header::before {
        ...
        bottom: 0;
        background: 
            radial-gradient(circle at 20% 30%, rgba(168, 185, 204, 0.2) 0%, transparent 50%),
            radial-gradient(circle at 80% 70%, rgba(168, 185, 204, 0.15) 0%, transparent 50%);
        pointer-events: none;
    }
    ...
    body.dark-mode .sidebar h3 {
        color: #a8b9cc;
        border-bottom-color: rgba(168, 185, 204, 0.3);
    }
    ...
    body.dark-mode .sidebar a:hover {
        background: linear-gradient(135deg, rgba(168, 185, 204, 0.2) 0%, rgba(168, 185, 204, 0.1) 100%);
        color: #a8b9cc;
    }
    ...
    <div class="tutorial-header-content">
        ...
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    ...
                    data-favorite-slug="c" 
                    data-favorite-name="{{ trans('app.formations.c.title') }}"
...
<script>
    ...
    @auth
    (function() {
        const formationSlug = 'c';
        const sections = [
            'intro', 'syntax', 'variables', 'datatypes', 'operators', 'conditions', 
            'loops', 'functions', 'pointers', 'arrays', 'structs', 'memory', 'files'
        ];
