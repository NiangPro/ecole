...
@push('head')
<x-course-schema slug="javascript" />
@endpush
...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.javascript.title'), 'url' => url()->current()],
    ];
@endphp
...
<style>
    * {
    ...
    .tutorial-header::before {
        ...
        bottom: 0;
        background: 
            radial-gradient(circle at 20% 30%, rgba(247, 223, 30, 0.2) 0%, transparent 50%),
            radial-gradient(circle at 80% 70%, rgba(247, 223, 30, 0.15) 0%, transparent 50%);
        pointer-events: none;
    }
...
<div class="tutorial-header">
    <div class="tutorial-header-content">
        <h1>
            <i class="fab fa-js" style="margin-right: 15px;"></i>
            {{ trans('app.formations.javascript.title') }}
        </h1>
        <p>{{ trans('app.formations.javascript.subtitle') }}</p>
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    data-favorite-type="formation" 
                    data-favorite-slug="javascript" 
                    data-favorite-name="{{ trans('app.formations.javascript.title') }}"
...
<script>
    ...
    @auth
    (function() {
        const formationSlug = 'javascript';
        const sections = [
            'intro', 'variables', 'datatypes', 'operators', 'conditions', 'loops', 
            'functions', 'arrays', 'objects', 'dom', 'events', 'es6', 'async'
        ];
            ...
            notification.innerHTML = `
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.9rem; opacity: 0.9;">Félicitations ! Vous avez terminé la formation JavaScript.</p>
                    </div>
                </div>
            `;
