...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.ia.title'), 'url' => url()->current()],
    ];
@endphp
...
<style>
    * {
    ...
    /* Bouton de copie - Même taille que le label AI */
    .copy-code-btn {
        position: absolute;
        top: 10px;
        right: 80px;
...
<div class="tutorial-header">
    <div class="tutorial-header-content">
        <h1>
            <i class="fas fa-robot" style="margin-right: 15px;"></i>
            {{ trans('app.formations.ia.title') }}
        </h1>
        <p>{{ trans('app.formations.ia.subtitle') }}</p>
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    data-favorite-type="formation" 
                    data-favorite-slug="ia" 
                    data-favorite-name="{{ trans('app.formations.ia.title') }}"
...
<script>
    ...
    @auth
    (function() {
        const formationSlug = 'ia';
        const sections = [
            'intro', 'concepts', 'ml', 'dl', 'nlp', 'cv', 
            'python', 'tensorflow', 'pytorch', 'models', 'apis', 'ethics'
        ];
            ...
            notification.innerHTML = `
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.9rem; opacity: 0.9;">Félicitations ! Vous avez terminé la formation IA.</p>
                    </div>
                </div>
            `;
