...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.csharp.title'), 'url' => url()->current()],
    ];
@endphp
    ...
    <div class="tutorial-header-content">
        ...
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    ...
                    data-favorite-slug="csharp" 
                    data-favorite-name="{{ trans('app.formations.csharp.title') }}"
