...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.java.title'), 'url' => url()->current()],
    ];
@endphp
    ...
    <div class="tutorial-header-content">
        ...
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    ...
                    data-favorite-slug="java" 
                    data-favorite-name="{{ trans('app.formations.java.title') }}"
