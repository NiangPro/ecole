...
@push('head')
<x-course-schema slug="bootstrap" />
@endpush
...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.bootstrap.title'), 'url' => url()->current()],
    ];
@endphp
...
<style>
    * {
    ...
    .tutorial-header::before {
        ...
        bottom: 0;
        background: 
            radial-gradient(circle at 20% 30%, rgba(121, 82, 179, 0.2) 0%, transparent 50%),
            radial-gradient(circle at 80% 70%, rgba(121, 82, 179, 0.15) 0%, transparent 50%);
        pointer-events: none;
    }
    ...
    body.dark-mode .sidebar h3 {
        color: #7952B3;
        border-bottom-color: rgba(121, 82, 179, 0.3);
    }
    ...
    body.dark-mode .sidebar a:hover {
        background: linear-gradient(135deg, rgba(121, 82, 179, 0.2) 0%, rgba(121, 82, 179, 0.1) 100%);
        color: #7952B3;
    }
...
<div class="tutorial-header">
    <div class="tutorial-header-content">
        <h1>
            <i class="fab fa-bootstrap" style="margin-right: 15px;"></i>
            {{ trans('app.formations.bootstrap.title') }}
        </h1>
        <p>{{ trans('app.formations.bootstrap.subtitle') }}</p>
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    data-favorite-type="formation" 
                    data-favorite-slug="bootstrap" 
                    data-favorite-name="{{ trans('app.formations.bootstrap.title') }}"
...
<script>
    ...
    @auth
    (function() {
        const formationSlug = 'bootstrap';
        const sections = [
            'intro', 'installation', 'grid', 'containers', 'typography', 'colors', 
            'buttons', 'navbar', 'cards', 'forms', 'modals', 'utilities'
        ];
            ...
            notification.innerHTML = `
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.9rem; opacity: 0.9;">Félicitations ! Vous avez terminé la formation Bootstrap.</p>
                    </div>
                </div>
            `;
