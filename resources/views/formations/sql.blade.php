...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.sql.title'), 'url' => url()->current()],
    ];
@endphp
    ...
    <div class="tutorial-header-content">
        ...
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    ...
                    data-favorite-slug="sql" 
                    data-favorite-name="{{ trans('app.formations.sql.title') }}"
...
<script>
    ...
    @auth
    (function() {
        const formationSlug = 'sql';
        const sections = [
            'intro', 'syntax', 'datatypes', 'operators', 'select', 'where', 
            'conditions', 'joins', 'aggregate', 'groupby', 'insert', 'subqueries', 'tables'
        ];
            ...
            notification.innerHTML = `
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.9rem; opacity: 0.9;">Félicitations ! Vous avez terminé la formation SQL.</p>
                    </div>
                </div>
            `;
