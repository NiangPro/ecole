...
@php
    $breadcrumbs = [
        ...
        ['name' => trans('app.formations.php.title'), 'url' => url()->current()],
    ];
@endphp
    ...
    <div class="tutorial-header-content">
        ...
        <div style="margin-top: 30px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
            <button data-favorite 
                    ...
                    data-favorite-slug="php" 
                    data-favorite-name="{{ trans('app.formations.php.title') }}"
...
<script>
    ...
    @auth
    (function() {
        const formationSlug = 'php';
        const sections = [
            'intro', 'syntax', 'variables', 'datatypes', 'operators', 'conditions', 
            'loops', 'functions', 'arrays', 'forms', 'sessions', 'mysql', 'pdo', 'oop'
        ];
            ...
            notification.innerHTML = `
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.9rem; opacity: 0.9;">Félicitations ! Vous avez terminé la formation PHP.</p>
                    </div>
                </div>
            `;
