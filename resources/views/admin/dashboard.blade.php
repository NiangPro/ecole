        ...
        <div class="article-item-card">
            <div style="flex: 1;">
                ...
                <div class="article-item-meta">
                    ...
                    <span><i class="fas fa-eye mr-1"></i>{{ number_format($article->views, 0, ',', ' ') }} vues</span>
    ...
    <div style="display: grid; gap: 15px;">
        ...
        <div class="article-item-card">
            <div style="flex: 1;">
                ...
                <div class="article-item-meta">
                    <span><i class="fas fa-folder mr-1"></i>{{ $article->category->name ?? 'Non catégorisé' }}</span>
                    <span><i class="fas fa-eye mr-1" style="color: #f59e0b;"></i><strong style="color: #f59e0b;">{{ number_format($article->views, 0, ',', ' ') }}</strong> vues</span>
