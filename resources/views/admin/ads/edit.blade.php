...
<div class="ads-form-wrapper">
    ...
    <div class="form-hero">
        <div class="form-hero-content">
            <h1><i class="fas fa-edit mr-3"></i>Modifier Publicité</h1>
            <p>Modifiez les paramètres de la publicité "{{ $ad->name }}"</p>
        </div>
    </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-main">
                ...
                <div class="form-card">
                    ...
                    <div id="adInternalImage" style="display: {{ old('image_type', $ad->image_type ?? 'external') === 'internal' ? 'block' : 'none' }};" class="field-group">
                    ...
                    <div id="adExternalImage" style="display: {{ old('image_type', $ad->image_type ?? 'external') === 'external' ? 'block' : 'none' }};" class="field-group">
    ...
    function updateAdImageVisibility() {
        if (adImageType.value === 'internal') {
            ...
            if (!adImageFile.files.length) {
                const currentImage = adPreviewImg.src;
                if (!currentImage || currentImage.includes('data:')) {
