...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    <div>
        ...
        <p class="text-gray-400">Créez une nouvelle catégorie d'emplois</p>
    </div>
...
<div class="content-section">
    <form action="{{ route('admin.jobs.categories.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div id="categoryExternalImage" style="display: {{ old('image_type') === 'external' ? 'block' : 'none' }};">
                        <input type="url" name="image" id="categoryImageUrl" value="{{ old('image') }}"
                    ...
                    <div id="categoryImagePreview" class="mt-4 hidden">
                        <img loading="lazy" id="categoryPreviewImg" src="" alt="Aperçu" class="w-full max-w-xs rounded-lg border border-cyan-500/20">
                    </div>
                </div>
