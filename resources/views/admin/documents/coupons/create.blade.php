...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    <div>
        <h3 class="text-3xl font-bold mb-2">Nouveau Code Promo</h3>
        <p class="text-gray-400">Créez un code de réduction</p>
    </div>
...
<div class="content-section">
    <form action="{{ route('admin.documents.coupons.store') }}" method="POST">
        @csrf
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" required
                           class="input-admin" style="font-family: monospace; text-transform: uppercase;" placeholder="Ex : BAC2026">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="input-admin" placeholder="Ex : Promo rentrée BAC">
                    @error('name')<p class="text-red-400 text-sm mt-1">{{ $message }}</p>@enderror
                </div>

                <div>
                    <label class="block text-cyan-400 mb-2 font-semibold">Description</label>
                    <textarea name="description" rows="3" class="input-admin">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="value" value="{{ old('value') }}" min="0" step="1" required class="input-admin">
                ...
                <div>
                    ...
                    <input type="number" name="minimum_amount" value="{{ old('minimum_amount') }}" min="0" class="input-admin" placeholder="Optionnel">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="usage_limit" value="{{ old('usage_limit') }}" min="1" class="input-admin" placeholder="Illimité">
                    ...
                    <div>
                        ...
                        <input type="number" name="user_limit" value="{{ old('user_limit', 1) }}" min="1" class="input-admin">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="starts_at" value="{{ old('starts_at') }}" class="input-admin">
                    ...
                    <div>
                        ...
                        <input type="date" name="expires_at" value="{{ old('expires_at') }}" class="input-admin">
