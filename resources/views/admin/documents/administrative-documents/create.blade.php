...
<div class="max-w-4xl mx-auto">
    ...
    <div class="admin-adm-doc-form-card p-6 rounded-xl bg-gray-800/70 border border-cyan-500/20">
        <h1 class="text-2xl font-bold mb-6 text-cyan-400">Nouvelle fiche document administratif</h1>
        <form action="{{ route('admin.documents.administrative-documents.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @include('admin.documents.administrative-documents._form', ['document' => null])
