...
@section('title', 'Modifier une Catégorie du Forum')
...
<div class="forum-categories-page">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h3 class="text-3xl font-bold">Modifier la Catégorie</h3>
    </div>
    ...
    <div class="content-section">
        <form action="{{ route('admin.forum.categories.update', $category) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="3" class="input-admin" placeholder="Description de la catégorie...">{{ old('description', $category->description) }}</textarea>
                @error('description')
                <p class="text-red-400 text-sm mt-2">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <div class="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
                    ...
                    <p class="text-gray-300 text-sm">
                        Cette catégorie contient <strong>{{ $category->topics_count }}</strong> topic(s).
                    </p>
                </div>
            </div>
