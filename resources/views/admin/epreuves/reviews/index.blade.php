...
@section('title', 'Modération des Avis - Épreuves')
...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    <div>
        <h3 class="text-3xl font-bold mb-2">Modération des Avis - Épreuves</h3>
        <p class="text-gray-400">Gérez et approuvez les avis laissés sur les épreuves & corrigés</p>
    </div>
</div>
...
<div class="content-section mb-6">
    <form method="GET" action="{{ route('admin.epreuves.reviews.index') }}" class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div>
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('admin.epreuves.reviews.index') }}" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg transition">
    ...
    <div class="reviews-table-wrapper">
        <table class="reviews-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="font-semibold">{{ $review->epreuve->title ?? 'Épreuve supprimée' }}</div>
                        @if($review->epreuve)
                        <div class="text-sm text-gray-400">{{ $review->epreuve->exam_label ?? $review->epreuve->level_label ?? '' }}</div>
                        @endif
                    </td>
                    <td>
                    ...
                    <td style="text-align: right;">
                        <div class="flex items-center justify-end gap-2">
                            @if(!$review->is_approved)
                                <form action="{{ route('admin.epreuves.reviews.approve', $review->id) }}" method="POST" class="inline" onsubmit="return confirm('Êtes-vous sûr de vouloir approuver cet avis ?');">
                                    @csrf
                            ...
                            @endif
                            <form action="{{ route('admin.epreuves.reviews.destroy', $review->id) }}" method="POST" class="inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet avis ? Cette action est irréversible.');">
                                @csrf
                                @method('DELETE')
