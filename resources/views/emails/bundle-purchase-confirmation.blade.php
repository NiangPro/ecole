        ...
        <tr>
            <td align="center">
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 30px rgba(15,23,42,0.08);">
                    <tr>
                        <td style="background:linear-gradient(135deg,#06b6d4,#14b8a6);padding:28px 32px;color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding:28px 32px;">
                            ...
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;">
                                Votre pack est prêt : <strong>{{ $purchase->bundle->name }}</strong>
                                ({{ $purchase->bundle->items->count() }} document{{ $purchase->bundle->items->count() > 1 ? 's' : '' }}).
                            </p>
                            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 20px;">
                                <tr>
                                    <td align="center" style="border-radius:12px;background:linear-gradient(135deg,#06b6d4,#14b8a6);">
                            ...
                            <p style="margin:0 0 16px;font-size:13px;color:#64748b;line-height:1.6;">
                                Le lien télécharge une archive .zip contenant tous les documents du pack.
                            </p>
                    ...
                    <tr>
                        <td style="padding:18px 32px;background:#f8fafc;color:#94a3b8;font-size:12px;text-align:center;">
                            NiangProgrammeur — Packs de documents
                        </td>
                    </tr>
                </table>
            </td>
